...
Revision ID: 6d1022cca52a
Revises: 
Create Date: 2025-03-11 07:00:22.564133
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['source_id'], ['tags.id'], ),
    sa.ForeignKeyConstraint(['target_id'], ['tags.id'], ),
